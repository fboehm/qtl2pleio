...
For technical support, please open a Github issue. If you're just getting started with `qtl2pleio`, please examine the vignettes and the [qtl2pleio package website](https://fboehm.us/static/software/qtl2pleio). You can also email <frederick.boehm@gmail.com> for assistance. 
...
```{r, echo = FALSE}
knitr::include_graphics("https://raw.githubusercontent.com/fboehm/qtl2pleio/master/man/figures/README-profile-plot-1.png")
```
