...
scatter1022 <- ggplot() + 
  ...
  ggtitle("Scatterplot of hot plate latency vs. percent time in light")
scatter1022
```
...
plot(out, map = pseudomap, 
     lodcolumn = 10, 
     main = "Genome-wide LOD for percent time in light"
     )
```
...
plot(out, map = pseudomap, 
     lodcolumn = 22, 
     main = "Genome-wide LOD for hot plate latency"
     )
```
